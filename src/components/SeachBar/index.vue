<template>
  <view>
    <view class="fixed top-0 left-0 z-20 h-screen w-screen" :class="toggleDimmer" />
    <form
    ...
    >
      <Icon
        ...
        class="text-rosybrown-400 hover:text-rosybrown-700 cursor-pointer pl-1 mr-2 search-icon"
        width="36"
        height="36"
